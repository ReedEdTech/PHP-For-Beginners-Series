                    ...
                    <?php if( $_SESSION['user'] ?? false) : ?> 
                        <div class="relative ml-3">
                            <form method="POST" action="/session">
                             ...
                             <!--<a href="/logout" class="<?= urlIs('/login') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Log Out</a>-->
                        </div>
                    <?php endif; ?>
